 ...
 * @Cyanilux
*/
[CreateAssetMenu(menuName = "Feature/BlitFeature")]
public class BlitFeature : ScriptableRendererFeature {

	public class BlitFeaturePass : ScriptableRenderPass {
		...
		public BlitFeaturePass(RenderPassEvent renderPassEvent, BlitSettings settings, string tag) {
		...
		public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData) {
			...
			if (settings.setInverseViewMatrix) {
				Shader.SetGlobalMatrix(InverseView, renderingData.cameraData.camera.cameraToWorldMatrix);
			}
	...
	public BlitFeaturePass blitPass;
	...
	public override void Create() {
		...
		blitPass = new BlitFeaturePass(settings.Event, settings, name);
