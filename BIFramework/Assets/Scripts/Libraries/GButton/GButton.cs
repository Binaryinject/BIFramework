...
namespace Seaeees.GButton
{
    public class GButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        [SerializeField] private bool useScaleAnimationOnClick = true;
        ...
        [SerializeField] private Vector2 scaleOnHover = new(0.05f, 0.05f);
        [SerializeField] private float scaleDurationOnHover = 0.15f;
        [SerializeField] private EaseType scaleEaseTypeOnHover = EaseType.QuadOut;
        [SerializeField] private Vector2 scaleOnClick = new(-0.05f, -0.05f);
        [SerializeField] private float scaleDurationOnClick = 0.15f;
        [SerializeField] private EaseType scaleEaseTypeOnClick = EaseType.QuadOut;
