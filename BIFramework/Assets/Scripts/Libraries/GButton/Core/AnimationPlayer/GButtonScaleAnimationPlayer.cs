...
namespace Seaeees.GButton.Core
{
	internal class GButtonScaleAnimationPlayer
	{
		...
		private Vector2 scaleOnHover;
		private Vector2 scaleOnClick;
		private EaseType scaleEaseTypeOnHover;
		private EaseType scaleEaseTypeOnClick;
		private float scaleDurationOnClick;
		private float scaleDurationOnHover;
		...
		{
			_calculatedScaleOnHover = new Vector2(_defaultScale.x + _defaultScale.x * scaleOnHover.x, _defaultScale.y + _defaultScale.x * scaleOnHover.y);
			_calculatedScaleOnClick = new Vector2(_defaultScale.x + _defaultScale.x * scaleOnClick.x, _defaultScale.y + _defaultScale.x * scaleOnClick.y);
		}
