...
namespace MikuLuaProfiler
{
    ...
    public class PreCompileFolderInfo
    {
        ...
        public List<string> lastModifyDictKeys = new();
        public List<long> lastModifyDictValues = new();
    ...
    public class LuaProfilerPrecompileSetting : ScriptableObject
    {
        ...
        #region memeber
        public List<PreCompileFolderInfo> luaDirList = new();
        public string outFolder = "LuaOut";
        public string luaSuffix = "*.lua";
        public List<string> luaFilterDirList = new();
