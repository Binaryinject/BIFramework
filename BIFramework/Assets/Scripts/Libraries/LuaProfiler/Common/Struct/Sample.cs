...
namespace MikuLuaProfiler
{
    ...
    public class LuaRefInfo : NetBase
    {
        ...
        #region pool
        private static ObjectPool<LuaRefInfo> m_pool = new(32);
    ...
    {
        #region field
        public Dictionary<LuaTypes, HashSet<string>> addRef = new();
        public Dictionary<string, List<string>> addDetail = new();
        public Dictionary<LuaTypes, HashSet<string>> rmRef = new();
        public Dictionary<string, List<string>> rmDetail = new();
        public Dictionary<LuaTypes, HashSet<string>> nullRef = new();
        public Dictionary<string, List<string>> nullDetail = new();
        #endregion

        #region pool
        private static ObjectPool<LuaDiffInfo> m_pool = new(32);
    ...
    public class Sample : NetBase
    {
        ...
        public MList<Sample> childs = new(16);
        ...
        private static Dictionary<object, Dictionary<object, string>> m_fullNamePool = new();
        public static ObjectPool<Sample> samplePool = new(8192);
