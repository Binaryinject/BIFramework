...
namespace MikuLuaProfiler
{
    ...
    public class HookLuaSetup : MonoBehaviour
    {
        ...
        private static Queue<Action> actionQueue = new();
    ...
    public class LuaHook
    {
        ...
        #region luastring
        public static readonly Dictionary<long, object> stringDict = new();
    ...
    public class MikuLuaProfilerLuaProfilerWrap
    {
        ...
        public static LuaCSFunction beginSample = new(BeginSample);
        public static LuaCSFunction beginSampleCustom = new(BeginSampleCustom);
        public static LuaCSFunction endSample = new(EndSample);
        public static LuaCSFunction unpackReturnValue = new(UnpackReturnValue);
        public static LuaCSFunction addRefFunInfo = new(AddRefFunInfo);
        public static LuaCSFunction removeRefFunInfo = new(RemoveRefFunInfo);
        public static LuaCSFunction checkType = new(CheckType);
        public static LuaCSFunction handleError = new(HandleError);
