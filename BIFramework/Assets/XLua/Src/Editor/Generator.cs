...
namespace CSObjectWrapEditor
{
    ...
    {
        static LuaEnv luaenv = new();
        static List<string> OpMethodNames = new() { "op_Addition", "op_Subtraction", "op_Multiply", "op_Division", "op_Equality", "op_UnaryNegation", "op_LessThan", "op_LessThanOrEqual", "op_Modulus",
        ...
        static bool isMethodInBlackList(MethodBase mb)
        {
            ...
            if (mb.GetParameters().Any(pInfo => pInfo.ParameterType.IsPointer || pInfo.ParameterType.IsByRefLike)) return true;
#else
        ...
        static Dictionary<string, LuaFunction> templateCache = new();
...
#pragma warning restore 618
        ...
        static Dictionary<Type, int> type_size = new()
        {
            { typeof(byte), 1 },
            { typeof(sbyte), 1 },
            { typeof(short), 2 },
