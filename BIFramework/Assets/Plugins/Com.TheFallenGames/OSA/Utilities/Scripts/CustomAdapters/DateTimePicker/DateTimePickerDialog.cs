...
namespace Com.TheFallenGames.OSA.CustomAdapters.DateTimePicker
{
	...
	public class DateTimePickerDialog : MonoBehaviour
	{
		...
		public static DateTimePickerDialog Show(Action<DateTime> onSelected) { return Show(DateTime.Now, onSelected); }
		public static DateTimePickerDialog Show(DateTime startingDate, Action<DateTime> onSelected) { return Show(startingDate, onSelected, DEFAULT_WIDTH, DEFAULT_HEIGHT); }
		public static DateTimePickerDialog Show(DateTime startingDate, Action<DateTime> onSelected, float width, float height)
		{
			var go = Resources.Load<GameObject>(OSAConst.OSA_PATH_IN_RESOURCES + "/" + typeof(DateTimePickerDialog).Name);
