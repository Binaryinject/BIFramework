...
namespace Pathfinding {
	...
	public interface ITraversalProvider {
		...
		///
		/// Note: In Unity 2021.3 or newer this property has a default implementation returning true. In earlier versions of Unity a default implementation
		/// cannot be added because of restrictions in the C# runtime.
		/// </summary>
...
#else
			// Unity <2021.3 does not have support for default interface implementations.
			get;
#endif
		}
		...
		/// </code>
		///
		/// Note: In Unity 2021.3 or newer this method has a default implementation forwarding to <see cref="CanTraverse(Path,GraphNode)"/>. In earlier versions of Unity a default implementation
		/// cannot be added because of restrictions in the C# runtime.
		/// </summary>
#if UNITY_2021_3_OR_NEWER
