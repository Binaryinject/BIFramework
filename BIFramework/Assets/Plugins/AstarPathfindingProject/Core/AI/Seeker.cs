...
namespace Pathfinding {
	...
	[HelpURL("http://arongranberg.com/astar/documentation/beta/class_pathfinding_1_1_seeker.php")]
	public class Seeker : VersionedMonoBehaviour {
		...
		/// This path can be sent to <see cref="StartPath(Path,OnPathDelegate)"/> with no change, but if no change is required <see cref="StartPath(Vector3,Vector3,OnPathDelegate)"/> does just that.
		/// <code>
