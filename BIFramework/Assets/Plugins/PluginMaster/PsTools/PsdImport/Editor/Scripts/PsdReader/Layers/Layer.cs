...
namespace PluginMaster
{
    ...
    public class Layer
    {
        ...
        public bool VisibleInHierarchy { get { return _visibleInHierarchy; } set { _visibleInHierarchy = value; } }

        public float Alpha { get { return Mathf.Round((float)Opacity * 100f / 255f) / 100f; } }
    ...
    {
        private List<Layer> _chlindren = new();
        public Layer[] Children { get { return _chlindren.ToArray(); } }
